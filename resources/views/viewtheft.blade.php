...
<body>
    ...
    <div class="mx-auto mt-10 ">
        ...
        <div class="bg-white p-6 rounded shadow-lg  lg:!w-[50%]  mx-auto">
            ...
            <h2 class="text-4xl font-bold mb-4">Theft Details</h2>
            <form id="SubForm">
                <!--@csrf-->
                <div class="mb-4" >
                ...
                <div class="mb-4" >
                    <label for="custphone" class="block text-gray-700 font-bold mb-2">Items  </label>
                    <input type="text" id="items" name="items" disabled class="w-full  border-gray-300 border-2 rounded p-3" value="{{$t->items}}">
                </div>
                
                <div class="mb-4" >
                    <label for="custphone" class="block text-gray-700 font-bold mb-2">Date Stolen  </label>
                    @php 
                    ...
                    @endphp
                    <input type="text" id="dated" name="items" disabled class="w-full  border-gray-300 border-2 rounded p-3" value="{{$dated}}">
                </div>

                 <div class="mb-4" >
                    <label for="custphone" class="block text-gray-700 font-bold mb-2">Time Stolen</label>
                    @php 
                         $d = date('g:i a', strtotime($t->time_stolen));
                    @endphp
