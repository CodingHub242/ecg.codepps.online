...
<body>
    ...
    <div class="mx-auto mt-10 ">
        ...
        <div class="bg-white p-6 rounded shadow-lg  lg:!w-[50%]  mx-auto">
            ...
            <h2 class="text-4xl font-bold mb-4">Electricity Request Details</h2>
            <form id="SubForm">
                <!--@csrf-->
                <div class="mb-4" >
                ...
                <div class="mb-4" >
                    <label for="custphone" class="block text-gray-700 font-bold mb-2">Date & Time Of Request</label>
                    @php 
         ...
         <script>
              function ChangeStat()
             {
                 ...
                 $.ajax({
                    ...
                    type: "POST",
                    url: "https://ecg.codepps.online/updatelight",
