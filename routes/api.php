...
Route::middleware(HandleCors::class)->group(function () {
 ...
 // ---------------------------------------------------------------------------
    ...
    // Delete an employee by code (for sync)
    Route::delete('/employees/code/{code}', [EmployeeController::class, 'destroyByCode']);
    ...
    // Get all deleted employee codes
    ...
    // Record a deleted employee code
